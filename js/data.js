...
const CHAINS = {
  ...
  {name:"Stick",icon:"🪵",image:"assets/wood/wood_01_stick.png"},
  {name:"Wood Log",icon:"🪵",image:"assets/wood/wood_02_log.png"},
  {name:"Timber Stack",icon:"🪵",image:"assets/wood/wood_03_timber_stack.png"},
  {name:"Wood Pile",icon:"🪵",image:"assets/wood/wood_04_wood_pile.png"},
  {name:"Lumber Bundle",icon:"🪵",image:"assets/wood/wood_05_lumber_bundle.png"},
  {name:"Magic Wood",icon:"✨",image:"assets/wood/wood_06_magic_wood.png"},
  {name:"Enchanted Timber",icon:"✨",image:"assets/wood/wood_07_enchanted_timber.png"},
  {name:"Ancient Sacred Wood",icon:"🌳",image:"assets/wood/wood_08_ancient_sacred_wood.png"}
  ]},
